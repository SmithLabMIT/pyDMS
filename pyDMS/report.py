...
def generate(gas, report_name):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        elements.append(Paragraph(
            f"Analysis performed at {formatted_datetime}",
            styles["Normal"]))
        ...
        elements.append(Paragraph("van't Hoff Relationships",
                                  styles["Heading2"]))
        elements.append(Spacer(1, 12))
        ...
        data = [["Parameter", "Value"],
                [Paragraph("ΔH<sub>D</sub> Initial Guess Range",
                           centered_para),
                f"{settings.get('dHD_guess')}"],
                [Paragraph("ΔH<sub>b</sub> Initial Guess Range",
                           centered_para),
                f"{settings.get('dHb_guess')}"],
                [Paragraph("k<sub>D,0</sub> Initial Guess Range",
                           centered_para),
